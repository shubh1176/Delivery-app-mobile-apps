...
export const estimateCourierOrder = async (data: CourierEstimateRequest): Promise<EstimateResponse> => {
  const response = await axios.post('/api/orders/courier/estimate', data);
  return response.data.data;
};

export const createCourierOrder = async (data: CourierOrderRequest): Promise<OrderResponse> => {
  const response = await axios.post('/api/orders/courier/create', data);
  return response.data.data;
}; 